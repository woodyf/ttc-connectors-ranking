...
public class RankingController {
	...
	public List<RankedAuthor> getPossitiveRanking(@PathVariable("topic") String topic) {
		logger.info(append("service-name", appName), ">>> Getting Possitive Ranked Authors for Campaign: " + topic);
	...
	public void rank(@PathVariable("topic") String topic, @PathVariable("attitude") String attitude,
			@PathVariable("author") String author) {
		logger.info(append("service-name", appName),
				">>> Manual Ranking Author: " + author + " for Campaign: " + topic + "-" + attitude);
		rankingService.rank(topic + "-" + attitude, author);
	}
